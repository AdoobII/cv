...
\name{Mohammed Adib}{Obaid}
\address{Wasserburger landstraße 88, 81827 Munich Germany}
\mobile{(+49) 1522-853-1471}

\email{adib.obaid@tum.de}
...
\position{Embedded systems engineer} % Your expertise/fields {\enskip\cdotp\enskip} <= seperator
% \quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{}{Mohammed Adib~~~·~~~CV}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
